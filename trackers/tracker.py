...
class Tracker: 
    ...
    def get_object_tracks(self, frames, read_from_stub=False, stub_path=None):
        ...
        """data structure of detection:  
        {"bbox": [50, 50, 150, 150], "class_id": 0, "confidence": 0.9, "class_name": "player"},"""
        

    """data structure of detection with object : 
            
                "bbox": [50, 60, 200, 220],  # Bounding box
                "class_id": 0,               # Class ID cho "player"
                "confidence": 0.95,          # Độ tự tin
                "track_id": 1                # Track ID
    """
    ...
    def draw_annotation(self,video_frames, tracks): 
        ...
        for frame_num, frame in enumerate(video_frames): 
            ...
            for track_id, player in player_dict.items():
                color = tuple(map(int, player.get("team_color", (0, 255, 255))))  # chuyển đổi RGB thành số nguyên
